...
public class TrackHandlerTower : DefaultTrackableEventHandler
{
    //DELEGAT
        ...
        TrackableBehaviour.Status newStatus)
    {
        ...
        if (newStatus == TrackableBehaviour.Status.DETECTED || newStatus == TrackableBehaviour.Status.TRACKED)
        {
            ...
            this.ObjectDetected += GroundPlaneTower.OnObjectFound;
            this.ObjectDetected += DimenzijeTower.OnObjectFound;
