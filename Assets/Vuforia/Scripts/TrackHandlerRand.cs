...
public class TrackHandlerRand : DefaultTrackableEventHandler
{
    //DELEGAT
        ...
        TrackableBehaviour.Status newStatus)
    {
        ...
        {
            this.ObjectDetected += GroundPlaneRand.OnObjectFound;
            this.ObjectDetected += DimenzijeRand.OnObjectFound;
